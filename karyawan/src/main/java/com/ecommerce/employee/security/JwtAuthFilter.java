 ...
 * service, gak cuma andalin gateway. Kalau token valid, isi SecurityContext
 * (principal = userId, authority = role) supaya @PreAuthorize dan
 * Authentication di controller bisa dipakai buat ownership check.
 */
@Component
